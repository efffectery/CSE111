def main():
    ...
    if vin in vehicles_dict:
        ...
        list_of_infromation_of_car_user_wants = vehicles_dict[f"{vin}"]

        # Print the manufacturer, model, and color of the vehicle.
        # Don't print the year, engine design, or displacement.
        print(f"The Manufacturer is {list_of_infromation_of_car_user_wants[1]}\nThe Model is {list_of_infromation_of_car_user_wants[2]}\nThe Color is {list_of_infromation_of_car_user_wants[3]}")
